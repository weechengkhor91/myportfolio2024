...
function ProjectCard({ imgUrl, title, description }) {
  return (
    <Fragment>
      <div>
        <div
          className="h-52 md:h-72 rounded-t-xl relative group overflow-hidden bg-center bg-no-repeat bg-white"
          style={{
        ...
        <div className="rounded-b-xl py-6 px-4 text-white bg-primary-950">
          <h4 className="text-xl font-semibold">{title}</h4>
          <p className="text-[#adb7be]">
            <span>
              <ChevronDoubleRightIcon className="h-5 w-5 inline mr-1" />
            </span>
            {description}
          </p>
        </div>
