        ...
        <nav className="fixed top-0 left-0 right-0 z-10 bg-[#fff] shadow ">
            <div className="flex flex-wrap items-center justify-between mx-auto py-4 px-3">
                ...
                <div className="mobile-menu block md:hidden">
                    {
                        !navbar ? 
                        <button onClick={() => setNavbar(true)} className="flex items-center px-3 py-2 border rounded">
                            <Bars3Icon className="h-5 w-5"/>
                        </button> 
                        : 
                        <button onClick={() => setNavbar(false)} className="flex items-center px-3 py-2 border rounded">
