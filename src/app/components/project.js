...
const projectsData = [
  ...
  },
  {
    id: 6,
    title: "Y Hotel",
    image: "/images/projects/y-hotel-home.jpg",
  ...
  },
  {
    id: 7,
    title: "Y Yatch",
    image: "/images/projects/yatch-packages.jpg",
    description: "HTML, CSS, Javascript",
    tag: ["All", "Web", "Mobile"],
  },
];
...
function Project() {
  ...
  return (
    <motion.section ref={ref} id="sec-projects">
      <div className="container mx-auto px-4">
        <h3 className="text-6xl sm:text-8xl md:text-9xl font-bold text-center text-big-header relative top-5 -z-10">
          My Projects
        </h3>
        <h3 className="text-4xl font-bold mb-4 text-center text-[#252525]">
          My Projects
        </h3>
